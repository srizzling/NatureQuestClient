...
public class BalloonOverlayView<Item extends OverlayItem> extends FrameLayout {
	...
	protected void setupView(Context context, final ViewGroup parent) {
		...
		View v = inflater.inflate(com.naturequest.R.layout.balloon_overlay, parent);
		title = (TextView) v.findViewById(com.naturequest.R.id.balloon_item_title);
		snippet = (TextView) v.findViewById(com.naturequest.R.id.balloon_item_snippet);

		ImageView close = (ImageView) v.findViewById(com.naturequest.R.id.balloon_close);
